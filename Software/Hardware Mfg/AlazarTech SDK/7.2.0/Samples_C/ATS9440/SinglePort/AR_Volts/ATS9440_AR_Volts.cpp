...
// AcqToDisk.cpp :
//
// This program demonstrates how to configure an ATS9440 to acquire to on-board memory,
...
BOOL ConfigureBoard(HANDLE boardHandle)
{
    ...
    InputRangeIds['C' - 'A'] = INPUT_RANGE_PM_400_MV;
    ...
    InputRangeIds['D' - 'A'] = INPUT_RANGE_PM_400_MV;
