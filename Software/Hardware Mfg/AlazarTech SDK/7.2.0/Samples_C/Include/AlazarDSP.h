 ...
 * *less than* 5. For modules with version 5.0 and above, please refer to the
...
enum FFT_OUTPUT_FORMAT {
    FFT_OUTPUT_FORMAT_U32_AMP2 = 0x0,        ///< 32-bit unsigned integer
                                             /// amplitude squared output.
                                             /// Pre-DSP v5.0 only.
    FFT_OUTPUT_FORMAT_U16_LOG = 0x1,         ///< 16-bit unsigned integer
                                             /// logarithmic amplitude output.
                                             /// Pre-DSP v5.0 only.
    FFT_OUTPUT_FORMAT_U16_AMP2 = 0x101,      ///< 16-bit unsigned integer
                                             /// amplitude squared output.
                                             /// Pre-DSP v5.0 only.
    FFT_OUTPUT_FORMAT_U8_LOG = 0x2,          ///< 8-bit unsigned integer
                                             /// logarithmic amplitude output.
                                             /// Pre-DSP v5.0 only.
    FFT_OUTPUT_FORMAT_U8_AMP2 = 0x102,       ///< 8-bit unsigned integer
                                             /// amplitude squared output.
    FFT_OUTPUT_FORMAT_S32_REAL = 0x3,        ///< 32-bit signed integer
                                             /// real part of FFT output.
    FFT_OUTPUT_FORMAT_S32_IMAG = 0x4,        ///< 32-bit signed integer
                                             /// imaginary part of FFT output.
    FFT_OUTPUT_FORMAT_FLOAT_AMP2 = 0xA,      ///< 32-bit floating point
                                             /// amplitude squared output.
    FFT_OUTPUT_FORMAT_FLOAT_LOG = 0xB,       ///< 32-bit floating point
                                             /// logarithmic output.
    FFT_OUTPUT_FORMAT_RAW_PLUS_FFT = 0x1000, ///< Prepend each FFT output record
                                             /// with a signed 16-bit version of
                                             /// the time-domain data.
    FFT_OUTPUT_FORMAT_S32_AMP2 = 0x400,      ///< 32-bit signed integer
                                             /// amplitude squared output.
                                             /// DSP v5.0 and above only.
    FFT_OUTPUT_FORMAT_S32_LOG,               ///< 32-bit signed integer
                                             /// logarithmic amplitude output.
                                             /// DSP v5.0 and above only.
    FFT_OUTPUT_FORMAT_S32_PHASE,             ///< 32-bit signed integer
                                             /// phase output.
                                             /// DSP v5.0 and above only.
    FFT_OUTPUT_FORMAT_S16_REAL,              ///< 16-bit signed integer
                                             /// real part of FFT output.
                                             /// DSP v5.0 and above only.
    FFT_OUTPUT_FORMAT_S16_IMAG,              ///< 16-bit signed integer
                                             /// imaginary part of FFT output.
                                             /// DSP v5.0 and above only.
    FFT_OUTPUT_FORMAT_S16_LOG,               ///< 16-bit signed integer
                                             /// logarithmic amplitude output.
                                             /// DSP v5.0 and above only.
    FFT_OUTPUT_FORMAT_S16_AMP2,              ///< 16-bit signed integer
                                             /// amplitude squared output.
                                             /// DSP v5.0 and above only.
    FFT_OUTPUT_FORMAT_S16_PHASE,             ///< 16-bit signed integer
                                             /// phase output.
                                             /// DSP v5.0 and above only.
    FFT_OUTPUT_FORMAT_S8_REAL,               ///< 8-bit signed integer
                                             /// real part of FFT output.
                                             /// DSP v5.0 and above only.
    FFT_OUTPUT_FORMAT_S8_IMAG,               ///< 8-bit signed integer
                                             /// imaginary part of FFT output.
                                             /// DSP v5.0 and above only.
    FFT_OUTPUT_FORMAT_S8_LOG,                ///< 8-bit signed integer
                                             /// logarithmic amplitude output.
                                             /// DSP v5.0 and above only.
    FFT_OUTPUT_FORMAT_S8_AMP2,               ///< 8-bit signed integer
                                             /// amplitude squared output.
                                             /// DSP v5.0 and above only.
    FFT_OUTPUT_FORMAT_S8_PHASE,              ///< 8-bit signed integer
                                             /// phase output.
                                             /// DSP v5.0 and above only.
    FFT_OUTPUT_FORMAT_FLOAT_REAL,            ///< 32-bit floating point
                                             /// real part of FFT output.
                                             /// DSP v5.0 and above only.
    FFT_OUTPUT_FORMAT_FLOAT_IMAG,            ///< 32-bit floating point
                                             /// imaginary part of FFT output.
                                             /// DSP v5.0 and above only.
    FFT_OUTPUT_FORMAT_FLOAT_PHASE,           ///< 32-bit floating point
                                             /// phase output.
                                             /// DSP v5.0 and above only.
    FFT_OUTPUT_FORMAT_S16_AMP2_AND_PHASE,    ///< 16-bit signed integer
                                             /// amplitude squared plus
                                             /// phase output.
                                             /// DSP v5.0 and above only.
    FFT_OUTPUT_FORMAT_S16_LOG_AND_PHASE,     ///< 16-bit signed integer
                                             /// logarithmic amplitude plus
                                             /// phase output.
                                             /// DSP v5.0 and above only.
    FFT_OUTPUT_FORMAT_S16_REAL_AND_IMAG,     ///< 16-bit signed integer
                                             /// real plus imaginary parts
                                             /// of FFT output.
                                             /// DSP v5.0 and above only.
