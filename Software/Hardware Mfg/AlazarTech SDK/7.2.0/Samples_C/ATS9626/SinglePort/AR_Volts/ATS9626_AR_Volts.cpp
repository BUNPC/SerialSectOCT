...
// AcqToDisk.cpp :
//
// This program demonstrates how to configure an ATS9626 to acquire to on-board memory,
...
BOOL ConfigureBoard(HANDLE boardHandle)
{
    ...
    InputRangeIds['A' - 'A'] = INPUT_RANGE_PM_1_V_25;
    ...
    InputRangeIds['B' - 'A'] = INPUT_RANGE_PM_1_V_25;
