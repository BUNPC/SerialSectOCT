...
// AcqToDisk.cpp :
//
// This program demonstrates how to configure an ATS9360 to make a
...
BOOL AcquireData(HANDLE boardHandle)
{
    ...
    if (success)
    {
        U32 admaFlags = ADMA_EXTERNAL_STARTCAPTURE | ADMA_TRIGGERED_STREAMING | ADMA_FIFO_ONLY_STREAMING | ADMA_ALLOC_BUFFERS;
