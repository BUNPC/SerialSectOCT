...
{
    // This console program demonstrates how to configure an ATS9416
    ...
    class AcqToDiskApp
    {
        ...
        static public bool ConfigureBoard(IntPtr boardHandle)
        {
            ...
            UInt32 sampleRateId = AlazarAPI.SAMPLE_RATE_100MSPS;
        ...
        static public unsafe bool AcquireData(IntPtr boardHandle)
        {
            ...
            UInt32 channelMask = AlazarAPI.CHANNEL_A | AlazarAPI.CHANNEL_B | AlazarAPI.CHANNEL_C | AlazarAPI.CHANNEL_D | AlazarAPI.CHANNEL_E | AlazarAPI.CHANNEL_F | AlazarAPI.CHANNEL_G | AlazarAPI.CHANNEL_H | AlazarAPI.CHANNEL_I | AlazarAPI.CHANNEL_J | AlazarAPI.CHANNEL_K | AlazarAPI.CHANNEL_L | AlazarAPI.CHANNEL_M | AlazarAPI.CHANNEL_N | AlazarAPI.CHANNEL_O | AlazarAPI.CHANNEL_P;
                ...
                fixed (short* pBuffer = byteToShortArray.shorts)
                {
                    ...
                    retCode =
                        AlazarAPI.AlazarBeforeAsyncRead(boardHandle,
                                              ...
                                              AlazarAPI.ADMA_EXTERNAL_STARTCAPTURE | AlazarAPI.ADMA_TRIGGERED_STREAMING | AlazarAPI.ADMA_FIFO_ONLY_STREAMING | AlazarAPI.ADMA_ALLOC_BUFFERS);
                    if (retCode != AlazarAPI.ApiSuccess)
                    {
