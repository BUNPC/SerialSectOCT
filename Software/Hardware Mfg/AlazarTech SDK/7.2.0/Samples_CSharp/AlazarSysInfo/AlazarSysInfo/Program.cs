...
{
    // This program demonstrates how to get board system, and
    // board specific information about a board.
    ...
    class AlazarSysInfoApp
    {
        ...
        static public string BoardTypeToText(UInt32 boardType)
        {
            ...
            case AlazarAPI.ATS660:
                name = "ATS660";
                break;
            case AlazarAPI.ATS9461:
                name = "ATS9461";
                break;
            case AlazarAPI.ATS9462:
                name = "ATS9462";
                break;
            case AlazarAPI.ATS9850:
                name = "ATS9850";
                break;
            case AlazarAPI.ATS9870:
                name = "ATS9870";
                break;
            case AlazarAPI.ATS9310:
                name = "ATS9310";
                break;
            case AlazarAPI.ATS9325:
                name = "ATS9325";
                break;
            case AlazarAPI.ATS9350:
                name = "ATS9350";
                break;
            case AlazarAPI.ATS9351:
                name = "ATS9351";
                break;
            case AlazarAPI.ATS9410:
                name = "ATS9410";
                break;
            case AlazarAPI.ATS9440:
                name = "ATS9440";
                break;
            case AlazarAPI.ATS9625:
                name = "ATS9625";
                break;
            case AlazarAPI.ATS9626:
                name = "ATS9626";
                break;
            case AlazarAPI.ATS9360:
                name = "ATS9360";
                break;
            case AlazarAPI.ATS9373:
                name = "ATS9373";
                break;
            case AlazarAPI.ATS9416:
                name = "ATS9416";
                break;
            case AlazarAPI.AXI9870:
                name = "AXI9870";
                break;
            default:
                name = "?";
