...
{
    // This console program demonstrates how to configure an ATS460
    ...
    class AcqToDiskApp
    {
        ...
        static public bool ConfigureBoard(IntPtr boardHandle)
        {
            ...
            UInt32 sampleRateId = AlazarAPI.SAMPLE_RATE_125MSPS;
                ...
                fixed (short* pBuffer = byteToShortArray.shorts)
                {
                    ...
                    retCode =
                        AlazarAPI.AlazarBeforeAsyncRead(boardHandle,
                                              ...
                                              AlazarAPI.ADMA_EXTERNAL_STARTCAPTURE | AlazarAPI.ADMA_CONTINUOUS_MODE | AlazarAPI.ADMA_ALLOC_BUFFERS);
                    if (retCode != AlazarAPI.ApiSuccess)
                    {
