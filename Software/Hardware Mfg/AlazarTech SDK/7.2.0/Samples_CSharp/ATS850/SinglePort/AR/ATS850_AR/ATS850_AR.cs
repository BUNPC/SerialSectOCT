...
namespace AR
{
    // This program demonstrates how to configure an ATS850 to acquire to
    ...
    { 
        ...
        static public bool ConfigureBoard(IntPtr boardHandle)
        {
            ...
            double samplesPerSec = 50000000.0;
            UInt32 sampleRateId = AlazarAPI.SAMPLE_RATE_50MSPS;
