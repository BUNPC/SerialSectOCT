...
CHANNEL_F                   =   hex2dec('00000020');
CHANNEL_G                   =   hex2dec('00000040');
CHANNEL_H                   =   hex2dec('00000080');
...
ADMA_INPUTIMPEDANCE         =   hex2dec('00000006');
...
NUM_DSP_WINDOW_ITEMS        = 6;

% DSP module type
% Used by AlazarDSPGetInfo().
DSP_MODULE_NONE = hex2dec('0000FFFF'); % avoids confusion with internal register.
DSP_MODULE_FFT  = DSP_MODULE_NONE + 1;
DSP_MODULE_PCD  = DSP_MODULE_NONE + 2;
...
% FFT output format
FFT_OUTPUT_FORMAT_U32           = hex2dec('0');     % 32-bit unsigned integer amplitude squared
FFT_OUTPUT_FORMAT_U16_LOG       = hex2dec('1');     % 16-bit unsigned integer logarithmic amplitude
FFT_OUTPUT_FORMAT_U16_AMP2      = hex2dec('101');   % 16-bit unsigned integer amplitude squared
FFT_OUTPUT_FORMAT_U8_LOG        = hex2dec('2');     % 8-bit unsigned integer logarithmic amplitude
FFT_OUTPUT_FORMAT_U8_AMP2       = hex2dec('102');   % 8-bit unsigned integer amplitude squared
FFT_OUTPUT_FORMAT_REAL_S32      = hex2dec('3');     % 32-bit signed integer real part of FFT
FFT_OUTPUT_FORMAT_IMAG_S32      = hex2dec('4');     % 32-bit signed integer imaginary part of FFT
FFT_OUTPUT_FORMAT_FLOAT_AMP2    = hex2dec('A');     % 32-bit floating point amplitude squared
FFT_OUTPUT_FORMAT_FLOAT_LOG     = hex2dec('B');     % 32-bit floating point logarithmic 
FFT_OUTPUT_FORMAT_RAW_PLUS_FFT  = hex2dec('1000');  % Prepend each FFT output record with 
                                                    % a signed 16-bit version of the time-domain data.

% FFT footer
FFT_FOOTER_NONE = hex2dec('0');
FFT_FOOTER_NPT  = hex2dec('1');
