...
/// \endcond
	...
	typedef enum BNT_CurrentLimit : WORD
	{
	...
	typedef enum BNT_OutputLowPassFilter : WORD
	{
	...
	typedef enum BNT_FeedbackSignalSelection : WORD
	{
	...
	/// <summary> Feedback signal selection definitions. </summary>
	typedef enum BNT_BNCTriggerModes : WORD
	{
	...
	typedef struct BNT_IO_Settings
	{
		...
		/// <summary> Channel feedback signal (legacy AC or DC derivative). </summary>
...
#pragma pack(1)
	...
	NANOTRAK_API short __cdecl  NT_SetNTChannels(char const * serialNo, short chanA, short chanB);
	...
	/// <seealso cref="NT_GetNTChannels(short &chanA, short &chanB)" />
	NANOTRAK_API short __cdecl NT_RequestNTChannels(char const * serialNo);
	...
	/// <seealso cref="NT_SetNTChannels(short chanA, short chanB)" />
	/// <seealso cref="NT_RequestNTChannels()" />
	NANOTRAK_API short __cdecl NT_GetNTChannels(char const * serialNo, short &chanA, short &chanB);
	...
	NANOTRAK_API short __cdecl NT_RequestMaxTravel(char const * serialNo);
	...
	NANOTRAK_API short __cdecl NT_GetMaxTravel(char const * serialNo, double &chanA, double &chanB);
