...
/// \endcond
	...
	/// <seealso cref="LD_GetMaxCurrentDigPot(char const * serialNo)" />
	KLASERDIODE_API short __cdecl LD_RequestMaxCurrentDigPot(char const * serialNo);
	...
	/// <seealso cref="LD_RequestMaxCurrentDigPot(char const * serialNo)" />
	/// <seealso cref="LD_GetLaserDiodeMaxCurrentLimit(const char *serialNo)" />
	KLASERDIODE_API short __cdecl LD_SetMaxCurrentDigPot(char const * serialNo, WORD maxCurrent);
	...
	/// <seealso cref="LD_SetMaxCurrentDigPot(char const * serialNo, WORD maxCurrent)" />
	/// <seealso cref="LD_GetMaxCurrentDigPot(char const * serialNo)" />
	KLASERDIODE_API short __cdecl LD_RequestLaserDiodeMaxCurrentLimit(const char *serialNo);

	/// <summary> Gets the Laser Diode max current limit. </summary>
	/// <param name="serialNo"> The serial no. </param>
	/// <returns> The maximum current limit as set by adjusting the max current digital pot, 0 to 32767 representing 0 to +230mA. </returns>
	/// <seealso cref="LD_RequestLaserDiodeMaxCurrentLimit(const char *serialNo)" />
	/// <seealso cref="LD_EnableMaxCurrentAdjust(char const * serialNo, bool enableAdjust, bool enableDiode)" />
	/// <seealso cref="LD_SetMaxCurrentDigPot(char const * serialNo, WORD maxCurrent)" />
	/// <seealso cref="LD_GetMaxCurrentDigPot(char const * serialNo)" />
	KLASERDIODE_API WORD __cdecl LD_GetLaserDiodeMaxCurrentLimit(const char *serialNo);
