...
/// \endcond
	...
	/// <seealso cref="TLI_GetDeviceListByTypeExt(char *receiveBuffer, DWORD sizeOfBuffer, int typeID)" />
	/// <seealso cref="TLI_GetDeviceListByTypesExt(char *receiveBuffer, DWORD sizeOfBuffer, int * typeIDs, int length)" />
	TLASERDIODE_API short __cdecl TLI_GetDeviceInfo(char const * serialNo, TLI_DeviceInfo *info);
	...
	/// <seealso cref="TLI_BuildDeviceList()" />
	/// <seealso cref="TLI_GetDeviceList(SAFEARRAY** stringsReceiver)" />
	TLASERDIODE_API void __cdecl TLI_InitializeSimulations();
	...
	TLASERDIODE_API void __cdecl TLI_UninitializeSimulations();
	...
	TLASERDIODE_API bool __cdecl LD_CheckConnection(char const * serialNo);
	...
	/// <returns> <c>true</c> if successful, false if not. </returns>
	///             \include CodeSnippet_connection1.cpp
	TLASERDIODE_API bool __cdecl LD_LoadNamedSettings(char const * serialNo, char const *settingsName);
	...
	/// <seealso cref="LD_GetMaxCurrentDigPot(char const * serialNo)" />
	TLASERDIODE_API short __cdecl LD_RequestMaxCurrentDigPot(char const * serialNo);
	...
	/// <seealso cref="LD_EnableMaxCurrentAdjust(char const * serialNo, bool enableAdjust, bool enableDiode)" />
	/// <seealso cref="LD_SetMaxCurrentDigPot(char const * serialNo, WORD maxCurrent)" />
	/// <seealso cref="LD_RequestMaxCurrentDigPot(char const * serialNo)" />
	/// <seealso cref="LD_GetLaserDiodeMaxCurrentLimit(const char *serialNo)" />
	...
	TLASERDIODE_API short __cdecl LD_RequestControlSource(char const * serialNo);
	...
	TLASERDIODE_API short __cdecl LD_RequestDisplay(char const * serialNo);
	...
	TLASERDIODE_API short __cdecl LD_RequestLaserSetPoint(char const * serialNo);
	...
	/// <summary> Requests the Laser Diode max current limit. </summary>
	/// <param name="serialNo"> The serial no. </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="LD_GetLaserDiodeMaxCurrentLimit(const char *serialNo)" />
	/// <seealso cref="LD_EnableMaxCurrentAdjust(char const * serialNo, bool enableAdjust, bool enableDiode)" />
	/// <seealso cref="LD_SetMaxCurrentDigPot(char const * serialNo, WORD maxCurrent)" />
	/// <seealso cref="LD_GetMaxCurrentDigPot(char const * serialNo)" />
	TLASERDIODE_API short __cdecl LD_RequestLaserDiodeMaxCurrentLimit(const char *serialNo);
	...
	/// <seealso cref="LD_RequestLaserDiodeMaxCurrentLimit(const char *serialNo)" />
	/// <seealso cref="LD_EnableMaxCurrentAdjust(char const * serialNo, bool enableAdjust, bool enableDiode)" />
	/// <seealso cref="LD_SetMaxCurrentDigPot(char const * serialNo, WORD maxCurrent)" />
	/// <seealso cref="LD_GetMaxCurrentDigPot(char const * serialNo)" />
	...
	TLASERDIODE_API short __cdecl LD_RequestWACalibFactor(char const * serialNo);
	...
	TLASERDIODE_API short __cdecl LD_RequestLaserPolarity(char const * serialNo);
	...
	TLASERDIODE_API bool __cdecl LD_TimeSinceLastMsgReceived(char const * serialNo, __int64 &lastUpdateTimeMS );
	...
	/// <seealso cref="LD_HasLastMsgTimerOverrun(char const * serialNo)" />
	/// \include CodeSnippet_connectionMonitoring.cpp
	TLASERDIODE_API void __cdecl LD_EnableLastMsgTimer(char const * serialNo, bool enable, __int32 lastMsgTimeout );
	...
	/// <seealso cref="LD_EnableLastMsgTimer(char const * serialNo, bool enable, __int32 lastMsgTimeout )" />
	/// \include CodeSnippet_connectionMonitoring.cpp
	TLASERDIODE_API bool __cdecl LD_HasLastMsgTimerOverrun(char const * serialNo);
