...
/// \endcond
	...
	BENCHTOPSTEPPERMOTOR_API bool __cdecl SBC_CheckConnection(char const * serialNo);
	...
	BENCHTOPSTEPPERMOTOR_API bool __cdecl SBC_NeedsHoming(char const * serialNo, short channel);
	...
	BENCHTOPSTEPPERMOTOR_API bool __cdecl SBC_CanMoveWithoutHomingFirst(char const * serialNo, short channel);
	...
	/// <param name="channel">  The channel (1 to n). </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	BENCHTOPSTEPPERMOTOR_API short __cdecl SBC_ClearMessageQueue(char const * serialNo, short channel);
	...
	BENCHTOPSTEPPERMOTOR_API short __cdecl SBC_RequestHomingParams(char const * serialNo, short channel);
	...
	/// <seealso cref="SBC_RequestHomingParams(char const * serialNo, short channel)" />
	/// <seealso cref="SBC_SetHomingVelocity(char const * serialNo, short channel, unsigned int velocity)" />
	/// <seealso cref="SBC_GetHomingParamsBlock(char const * serialNo, short channel, MOT_HomingParameters *homingParams)" />
	/// <seealso cref="SBC_SetHomingParamsBlock(char const * serialNo, short channel, MOT_HomingParameters *homingParams)" />
	...
	BENCHTOPSTEPPERMOTOR_API short __cdecl SBC_RequestJogParams(char const * serialNo, short channel);
	...
	/// 					 </list> </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="SBC_RequestJogParams(char const * serialNo, short channel)" />
	...
	/// <seealso cref="SBC_GetVelParams(char const * serialNo, short channel, int * acceleration, int * maxVelocity)" />
	/// <seealso cref="SBC_GetVelParamsBlock(char const * serialNo, short channel, MOT_VelocityParameters  *velocityParams)" />
	BENCHTOPSTEPPERMOTOR_API short __cdecl SBC_RequestVelParams(char const * serialNo, short channel);
	...
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="SBC_RequestVelParams(char const * serialNo, short channel)" />
	/// <seealso cref="SBC_SetVelParams(char const * serialNo, short channel, int acceleration, int maxVelocity)" />
	/// <seealso cref="SBC_GetVelParamsBlock(char const * serialNo, short channel, MOT_VelocityParameters  *velocityParams)" />
	/// <seealso cref="SBC_SetVelParamsBlock(char const * serialNo, short channel, MOT_VelocityParameters *velocityParams)" />
	/// <seealso cref="SBC_MoveToPosition(char const * serialNo, short channel, int index)" />
	...
	BENCHTOPSTEPPERMOTOR_API short __cdecl SBC_RequestBacklash(char const * serialNo, short channel);
	...
	/// <seealso cref="SBC_RequestBacklash(char const * serialNo, short channel)" />
	/// <seealso cref="SBC_SetBacklash(char const * serialNo, short channel, long distance)" />
	...
	BENCHTOPSTEPPERMOTOR_API short __cdecl SBC_RequestEncoderCounter(char const * serialNo, short channel);
	...
	/// <seealso cref="SBC_RequestEncoderCounter(char const * serialNo, short channel)" />
	/// <seealso cref="SBC_SetEncoderCounter(char const * serialNo, short channel, long count)" />
	...
	/// <param name="channel"> The channel (1 to n). </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="SBC_GetLimitSwitchParams(char const * serialNo, short channel, MOT_LimitSwitchModes * clockwiseHardwareLimit, MOT_LimitSwitchModes * anticlockwiseHardwareLimit, unsigned int * clockwisePosition, unsigned int * anticlockwisePosition, MOT_LimitSwitchSWModes * softLimitMode)" />
	/// <seealso cref="SBC_GetLimitSwitchParamsBlock(char const * serialNo, short channel, MOT_LimitSwitchParameters *limitSwitchParams)" />
	BENCHTOPSTEPPERMOTOR_API short __cdecl SBC_RequestLimitSwitchParams(char const * serialNo, short channel);
	...
	/// 					 </list> <remarks> If these are bitwise-ORed with 0x0080 then the limits are swapped. </remarks> </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="SBC_RequestLimitSwitchParams(char const * serialNo, short channel)" />
	...
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="SBC_RequestMoveAbsolutePosition(char const * serialNo, short channel)" />
	...
	/// <param name="channel"> The channel (1 to n). </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="SBC_GetMoveAbsolutePosition(char const * serialNo, short channel)" />
	/// <seealso cref="SBC_SetMoveAbsolutePosition(char const * serialNo, short channel, int position)" />
	/// <seealso cref="SBC_MoveAbsolute(char const * serialNo, short channel)" />
	BENCHTOPSTEPPERMOTOR_API short __cdecl SBC_RequestMoveAbsolutePosition(char const * serialNo, short channel);
	...
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="SBC_RequestMoveRelativeDistance(char const * serialNo, short channel)" />
	...
	/// <param name="channel"> The channel (1 to n). </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="SBC_GetMoveRelativeDistance(char const * serialNo, short channel)" />
	/// <seealso cref="SBC_SetMoveRelativeDistance(char const * serialNo, short channel, int distance)" />
	/// <seealso cref="SBC_MoveRelativeDistance(char const * serialNo, short channel)" />
	BENCHTOPSTEPPERMOTOR_API short __cdecl SBC_RequestMoveRelativeDistance(char const * serialNo, short channel);
	...
	/// <seealso cref="SBC_SetLimitSwitchParams(char const * serialNo, short channel, MOT_LimitSwitchModes clockwiseHardwareLimit, MOT_LimitSwitchModes anticlockwiseHardwareLimit, unsigned int clockwisePosition, unsigned int anticlockwisePosition, MOT_LimitSwitchSWModes softLimitMode)" />
	/// <seealso cref="SBC_GetLimitSwitchParams(char const * serialNo, short channel, MOT_LimitSwitchModes * clockwiseHardwareLimit, MOT_LimitSwitchModes * anticlockwiseHardwareLimit, unsigned int * clockwisePosition, unsigned int * anticlockwisePosition, MOT_LimitSwitchSWModes * softLimitMode)" />
	/// <seealso cref="SBC_SetLimitSwitchParamsBlock(const char * serialNo, short channel, MOT_LimitSwitchParameters *limitSwitchParams)" />
	...
	/// <seealso cref="SBC_GetLimitSwitchParams(char const * serialNo, short channel, MOT_LimitSwitchModes * clockwiseHardwareLimit, MOT_LimitSwitchModes * anticlockwiseHardwareLimit, unsigned int * clockwisePosition, unsigned int * anticlockwisePosition, MOT_LimitSwitchSWModes * softLimitMode)" />
	/// <seealso cref="SBC_SetLimitSwitchParams(char const * serialNo, short channel, MOT_LimitSwitchModes clockwiseHardwareLimit, MOT_LimitSwitchModes anticlockwiseHardwareLimit, unsigned int clockwisePosition, unsigned int anticlockwisePosition, MOT_LimitSwitchSWModes softLimitMode)" />
	/// <seealso cref="SBC_GetLimitSwitchParamsBlock(const char * serialNo, short channel, MOT_LimitSwitchParameters *limitSwitchParams)" />
	...
	/// 				 </list> </returns>
	/// <seealso cref="SBC_RequestTriggerSwitches(char const * serialNo, short channel)" />
	...
	BENCHTOPSTEPPERMOTOR_API short __cdecl SBC_RequestDigitalOutputs(char const * serialNo, short channel);
	...
	/// <seealso cref="SBC_SetDigitalOutputs(char const * serialNo, short channel, byte outputsBits)" />
	/// <seealso cref="SBC_RequestDigitalOutputs(char const * serialNo, short channel)" />
	...
	/// <param name="serialNo">	The controller serial no. </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="SBC_SetRackDigitalOutputs(char const * serialNo, byte outputsBits)" />
	/// <seealso cref="SBC_GetRackDigitalOutputs(char const * serialNo)" />
	BENCHTOPSTEPPERMOTOR_API short __cdecl SBC_RequestRackDigitalOutputs(char const * serialNo);
	...
	BENCHTOPSTEPPERMOTOR_API byte __cdecl SBC_GetRackDigitalOutputs(char const * serialNo);
	...
	/// <param name="channel"> The channel (1 to n). </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="SBC_GetPowerParams(char const * serialNo, short channel, MOT_PowerParameters *powerParams)" />
	/// <seealso cref="SBC_SetPowerParams(char const * serialNo, short channel, MOT_PowerParameters *powerParams)" />
	BENCHTOPSTEPPERMOTOR_API short __cdecl SBC_RequestPowerParams(char const * serialNo, short channel);
	...
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="SBC_RequestPowerParams(char const * serialNo, short channel)" />
	...
	/// <param name="channel"> The channel (1 to n). </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="SBC_GetBowIndex(char const * serialNo, short channel)" />
	/// <seealso cref="SBC_SetBowIndex(char const * serialNo, short channel, short bowIndex)" />
	BENCHTOPSTEPPERMOTOR_API short __cdecl SBC_RequestBowIndex(char const * serialNo, short channel);

	/// <summary> Gets the stepper motor bow index. </summary>
	/// <param name="serialNo"> The controller serial no. </param>
	/// <param name="channel">  The channel (1 to n). </param>
	/// <returns> The bow index. </returns>
	/// <seealso cref="SBC_RequestBowIndex(char const * serialNo, short channel)" />
	...
	/// <remarks> This is true if the stage supports PID Loop Encoding. (requires <see cref="SBC_GetPIDLoopEncoderCoeff(const char * serialNo)"/> to have a positive non zero coefficient</remarks>
	/// <param name="serialNo">	The controller serial no. </param>
	/// <param name="channel">  The channel (1 to n). </param>
	/// <returns> Success. </returns>
	/// <seealso cref="SBC_SetPIDLoopEncoderParams(const char * serialNo, short channel, MOT_PIDLoopEncoderParams * params)" />
	/// <seealso cref="SBC_SetPIDLoopEncoderCoeff(const char * serialNo, short channel, double coeff)" />
	/// <seealso cref="SBC_RequestPIDLoopEncoderParams(const char * serialNo, short channel)" />
	/// <seealso cref="SBC_GetPIDLoopEncoderParams(const char * serialNo, short channel, MOT_PIDLoopEncoderParams * params)" />
	/// <seealso cref="SBC_GetPIDLoopEncoderCoeff(const char * serialNo, short channel)" />
	BENCHTOPSTEPPERMOTOR_API bool __cdecl SBC_UsesPIDLoopEncoding(const char * serialNo, short channel);
	...
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="SBC_UsesPIDLoopEncoding(const char * serialNo, short channel)" />
	/// <seealso cref="SBC_SetPIDLoopEncoderCoeff(const char * serialNo, short channel, double coeff)" />
	/// <seealso cref="SBC_RequestPIDLoopEncoderParams(const char * serialNo, short channel)" />
	/// <seealso cref="SBC_GetPIDLoopEncoderParams(const char * serialNo, short channel, MOT_PIDLoopEncoderParams * params)" />
	/// <seealso cref="SBC_GetPIDLoopEncoderCoeff(const char * serialNo, short channel)" />
	BENCHTOPSTEPPERMOTOR_API short __cdecl SBC_SetPIDLoopEncoderParams(const char * serialNo, short channel, MOT_PIDLoopEncoderParams * params);
	...
	/// <seealso cref="SBC_GetPIDLoopEncoderParams(const char * serialNo, short channel, MOT_PIDLoopEncoderParams * params)" />
	/// <seealso cref="SBC_GetPIDLoopEncoderCoeff(const char * serialNo, short channel)" />
	BENCHTOPSTEPPERMOTOR_API short __cdecl SBC_SetPIDLoopEncoderCoeff(const char * serialNo, short channel, double coeff);
	...
	/// <seealso cref="SBC_GetPIDLoopEncoderCoeff(const char * serialNo, short channel)" />
	/// <seealso cref="SBC_GetPIDLoopEncoderParams(const char * serialNo, short channel, MOT_PIDLoopEncoderParams * params)" />
	BENCHTOPSTEPPERMOTOR_API short __cdecl SBC_RequestPIDLoopEncoderParams(const char * serialNo, short channel);
	...
	/// <seealso cref="SBC_SetPIDLoopEncoderCoeff(const char * serialNo, short channel, double coeff)"/>
	/// <seealso cref="SBC_GetPIDLoopEncoderCoeff(const char * serialNo, short channel)"/>
	BENCHTOPSTEPPERMOTOR_API short __cdecl SBC_GetPIDLoopEncoderParams(const char * serialNo, short channel, MOT_PIDLoopEncoderParams * params);
	...
	/// <seealso cref="SBC_SetPIDLoopEncoderCoeff(const char * serialNo, short channel, double coeff)" />
	/// <seealso cref="SBC_GetPIDLoopEncoderParams(const char * serialNo, short channel, MOT_PIDLoopEncoderParams * params)" />
	BENCHTOPSTEPPERMOTOR_API double __cdecl SBC_GetPIDLoopEncoderCoeff(const char * serialNo, short channel);

	/// <summary> Requests the joystick parameters. </summary>
	/// <param name="serialNo"> The serial no. </param>
	/// <param name="channel">  The channel (1 to n). </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="SBC_GetJoystickParams(const char * serialNo, short channel, MOT_JoystickParameters *JoystickParams)" />
	/// <seealso cref="SBC_SetJoystickParams(char const * serialNo, short channel, MOT_JoystickParameters *JoystickParams)" />
	BENCHTOPSTEPPERMOTOR_API short __cdecl SBC_RequestJoystickParams(char const * serialNo, short channel);
	...
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="SBC_RequestJoystickParams(char const * serialNo, short channel)" />
	/// <seealso cref="SBC_SetJoystickParams(char const * serialNo, short channel, MOT_JoystickParameters *joystickParams)" />
	...
	BENCHTOPSTEPPERMOTOR_API bool __cdecl SBC_TimeSinceLastMsgReceived(char const * serialNo, short channel, __int64 &lastUpdateTimeMS );
	...
	/// <seealso cref="SBC_HasLastMsgTimerOverrun(char const * serialNo, short channel)" />
	/// \include CodeSnippet_connectionMonitoring.cpp
	BENCHTOPSTEPPERMOTOR_API void __cdecl SBC_EnableLastMsgTimer(char const * serialNo, short channel, bool enable, __int32 lastMsgTimeout );
	...
	/// <seealso cref="SBC_EnableLastMsgTimer(char const * serialNo, short channel, bool enable, __int32 lastMsgTimeout )" />
	/// \include CodeSnippet_connectionMonitoring.cpp
	BENCHTOPSTEPPERMOTOR_API bool __cdecl SBC_HasLastMsgTimerOverrun(char const * serialNo, short channel);
	...
	BENCHTOPSTEPPERMOTOR_API short __cdecl SBC_GetDeviceUnitFromRealValue(char const * serialNo, short channel, double real_unit, int *device_unit, int unitType);
}
/** @} */ // BenchtopStepper