...
% xx=1670;    % xx is the X displacement of two adjacent tile align in the X direction
xx=1150;
xy=0;     % xy is the Y displacement of two adjacent tile align in the X direction, default to 0
% yy=-1580;    % yy is the Y displacement of two adjacent tile align in the Y direction
yy=1180;
...
datapath  = '/projectnb2/npbssmic/ns/PSOCT-qBRM_fiber_struct/sample03_2P/'; %  !!!!!!!!! 
nslice=11; % total number of slices !!!!!!!!!
...
for iFile=istart:istop
    ...
    % distortion correction
     ...
     channel1 = squeeze(Grid_correction(channel1, grid_matrix, 1500, 251, 1500, 251, 1));      
     channel2 = squeeze(Grid_correction(channel2, grid_matrix, 1500, 251, 1500, 251, 1)); 
