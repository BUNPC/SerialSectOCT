...
%     BaSiC_shading_and_ref_stitch_PTSD(id,datapath, 50, 44)
     ...
     BaSiC_shading_and_ref_stitch(islice,P2path,datapath, 154, height+15, 65);  % start depth, thickness(pixels): volume recon start depth needs to be configured for each sample
