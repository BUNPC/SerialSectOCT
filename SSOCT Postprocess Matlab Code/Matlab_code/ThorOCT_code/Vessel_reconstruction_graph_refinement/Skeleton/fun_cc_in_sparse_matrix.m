function cc = fun_cc_in_sparse_matrix(idx_list, mask_size) %#codegen
...
[cc.PixelIdxList, cc.NumObjects] = mex_fun_find_cc_in_sparse_matrix(idx_list, neighbor_voxel_idx);
% cc_length = 1000;
% t_num_cc = 0;
