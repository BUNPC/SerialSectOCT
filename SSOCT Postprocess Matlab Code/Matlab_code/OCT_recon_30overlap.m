...
nslice=11; % define total number of slice
...
%              ori = Grid_correction(ori, grid_matrix, 1050, 51, 1050, 51, size(ori,1));  
         ...
         start_pixel=40; % start depth needs to be configured for each sample !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
%     Ori_stitch('ori2D', P2path,datapath,disp,mosaic,pxlsize,islice,pattern,sys); 
    Gen_ori_RGB(datapath,islice, 0.07);
%     BaSiC_shading_and_ref_stitch(islice,P2path,datapath, numX*numY, 1, 180); % volume recon start depth, thickness(pixels)!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
%     BaSiC_shading_and_ori_stitch(islice,P2path,datapath, numX*numY, 1, 180); % volu
