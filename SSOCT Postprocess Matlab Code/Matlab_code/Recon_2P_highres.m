...
P2path  = '/projectnb2/npbssmic/ns/CTE_6894_2P/'; %                                    ADJUST FOR EACH SAMPLE!!!
nslice=42; % total number of slices                                                    ADJUST FOR EACH SAMPLE!!!
%% specify mosaic parameters
% xx yy is positive for dataset acquired after sep 06
%% for default 10% overlap
xx=1560;    % xx is the X displacement of two adjacent tile align in the X direction
% xx=1440;
xy=0;     % xy is the Y displacement of two adjacent tile align in the X direction, default to 0
yy=1550;    % yy is the Y displacement of two adjacent tile align in the Y direction
% yy=1440;
...
stitch_plane1=6;                                                                                           % ADJUST FOR EACH SAMPLE!!!
stitch_plane2=20;                                                                                          % ADJUST FOR EACH SAMPLE!!!
stitch_plane3=40;                                                                                          % ADJUST FOR EACH SAMPLE!!!
...
for iFile=istart:istop
    ...
    % distortion correction
     clear channel1
     clear channel2
     channel1(:,:) = imageData1(61:1760,199:1898); % Cut spare FOV and get rid of extreme distortion at the edge of FOV
     channel2(:,:) = imageData2(61:1760,199:1898);
