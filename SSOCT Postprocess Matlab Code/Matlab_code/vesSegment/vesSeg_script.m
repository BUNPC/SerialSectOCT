...
filename = strcat('/projectnb2/npbssmic/ns/Ann_Mckee_samples_20T/CTE_6912/ref_inv.tif');
...
savepath=strcat('/projectnb2/npbssmic/ns/Ann_Mckee_samples_20T/CTE_6912/ves_seg_grayscale.tif');
