...
directory = '/projectnb/npbssmic/ns/PSOCT-qBRM_fiber_struct/sample1_BRM/Slice_3/ROI1/';
fstack_and_stitch(directory, StitchingType);

directory = '/projectnb/npbssmic/ns/PSOCT-qBRM_fiber_struct/sample1_BRM/Slice_3/ROI2/';
fstack_and_stitch(directory, StitchingType);

directory = '/projectnb/npbssmic/ns/PSOCT-qBRM_fiber_struct/sample1_BRM/Slice_3/ROI3/';
fstack_and_stitch(directory, StitchingType);
