folder='/projectnb2/npbssmic/ns/Ann_8921/';
...
%         coord=num2str(iFile);
        ...
        Optical_fitting_8921(co,cross,islice, iFile, folder);
...
pxlsize=[1000 1000];
P2path='/projectnb2/npbssmic/ns/Ann_8921_2P/';
% AIP_stitch(datapath,disp,mosaic,pxlsize,islice,pattern,sys);  
Mus_stitch_8921('mus',P2path,folder,disp,mosaic,pxlsize./10,islice,pattern,sys);           % stitch mus
Mub_stitch_8921('mub', P2path,folder,disp,mosaic,pxlsize./10,islice,pattern,sys);
%     Ret_stitch('bfg', folder,disp,mosaic,pxlsize./4,islice,pattern,sys);
R2_stitch_8921('R2', P2path, folder,disp,mosaic,pxlsize./10,islice,pattern,sys);
% rewrite_aip_tiles(folder,islice,numX*numY);
% Bfg_stitch_8921('bfg', P2path, folder,disp,mosaic,pxlsize./10,islice,pattern,sys)
% 
% 
% MIP_stitch_8921('mip', P2path,folder,disp,mosaic,pxlsize,islice,pattern,sys)
