function Mub_stitch_6692(target, P2path, datapath,disp,mosaic,pxlsize,islice,pattern,sys)
%% define grid pattern
...
f=strcat(datapath,'aip/vol',num2str(2),'/TileConfiguration.registered.txt');
