function AIP_restitch(P2path, datapath,disp,mosaic,pxlsize,islice,pattern,sys)
%%% ---------------------- %%%
...
%         if std(aip(:))>=0.0019     % threshold tunable for agarose blocks, visual examine after done
%             tile_flag(j)=1;
...
%     toc
    ...
    f=strcat(datapath,'aip/vol',num2str(83),'/TileConfiguration.registered.txt');
