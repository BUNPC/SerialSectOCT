function Mub_stitch_Hui(target, P2path, datapath,disp,mosaic,pxlsize,islice,pattern,sys)
%% define grid pattern
...
f=strcat(P2path,'aip/vol1/TileConfiguration.registered.txt');
coord = read_Fiji_coord(f,'aip');
...
%         filename0=dir(strcat(num2str(in),'.mat'));
        filename0=dir(strcat('mub-1-',num2str(in),'.mat'));
        load(filename0.name);
