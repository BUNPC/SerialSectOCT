datapath='/projectnb2/npbssmic/ns/myelin_content_scattering_correlation_paper_data/somatosensory/';
...
filename0=dir(strcat('*.mat')); % count #tiles per slice
...
%         create_dir(islice, folder); 
    ...
    for iFile=istart:istop
        ...
        slice_index=islice;
        coord=str2num(name_dat{2});%num2str(iFile);
...
%         cross(11:end-10,:,:)=tmp;
        ...
        Optical_fitting_Hui_0530(ref,islice, coord, datapath);
