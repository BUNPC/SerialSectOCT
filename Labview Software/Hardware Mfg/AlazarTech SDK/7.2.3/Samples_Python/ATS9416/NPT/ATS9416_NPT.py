...
def ConfigureBoard(board):
    ...
    board.inputControlEx(ats.CHANNEL_C,
                         ats.DC_COUPLING,
                         ats.INPUT_RANGE_PM_1_V,
                         ats.IMPEDANCE_50_OHM)
    ...
    board.inputControlEx(ats.CHANNEL_D,
                         ats.DC_COUPLING,
                         ats.INPUT_RANGE_PM_1_V,
                         ats.IMPEDANCE_50_OHM)
    ...
    board.inputControlEx(ats.CHANNEL_E,
                         ats.DC_COUPLING,
                         ats.INPUT_RANGE_PM_1_V,
                         ats.IMPEDANCE_50_OHM)
    ...
    board.inputControlEx(ats.CHANNEL_F,
                         ats.DC_COUPLING,
                         ats.INPUT_RANGE_PM_1_V,
                         ats.IMPEDANCE_50_OHM)
    ...
    board.inputControlEx(ats.CHANNEL_G,
                         ats.DC_COUPLING,
                         ats.INPUT_RANGE_PM_1_V,
                         ats.IMPEDANCE_50_OHM)
    ...
    board.inputControlEx(ats.CHANNEL_H,
                         ats.DC_COUPLING,
                         ats.INPUT_RANGE_PM_1_V,
                         ats.IMPEDANCE_50_OHM)
    ...
    board.inputControlEx(ats.CHANNEL_I,
                         ats.DC_COUPLING,
                         ats.INPUT_RANGE_PM_1_V,
                         ats.IMPEDANCE_50_OHM)
    ...
    board.inputControlEx(ats.CHANNEL_J,
                         ats.DC_COUPLING,
                         ats.INPUT_RANGE_PM_1_V,
                         ats.IMPEDANCE_50_OHM)
    ...
    board.inputControlEx(ats.CHANNEL_K,
                         ats.DC_COUPLING,
                         ats.INPUT_RANGE_PM_1_V,
                         ats.IMPEDANCE_50_OHM)
    ...
    board.inputControlEx(ats.CHANNEL_L,
                         ats.DC_COUPLING,
                         ats.INPUT_RANGE_PM_1_V,
                         ats.IMPEDANCE_50_OHM)
    ...
    board.inputControlEx(ats.CHANNEL_M,
                         ats.DC_COUPLING,
                         ats.INPUT_RANGE_PM_1_V,
                         ats.IMPEDANCE_50_OHM)
    ...
    board.inputControlEx(ats.CHANNEL_N,
                         ats.DC_COUPLING,
                         ats.INPUT_RANGE_PM_1_V,
                         ats.IMPEDANCE_50_OHM)
    ...
    board.inputControlEx(ats.CHANNEL_O,
                         ats.DC_COUPLING,
                         ats.INPUT_RANGE_PM_1_V,
                         ats.IMPEDANCE_50_OHM)
    ...
    board.inputControlEx(ats.CHANNEL_P,
                         ats.DC_COUPLING,
                         ats.INPUT_RANGE_PM_1_V,
                         ats.IMPEDANCE_50_OHM)
