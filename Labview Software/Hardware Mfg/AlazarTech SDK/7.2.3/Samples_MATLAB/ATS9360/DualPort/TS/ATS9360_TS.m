...
retCode = ...
    AlazarSetCaptureClock(  ...
        ...
        SAMPLE_RATE_1800MSPS, ... % U32 -- sample rate id
...
retCode = AlazarBeforeAsyncRead(boardHandle, channelMask, 0, samplesPerBufferPerChannel, 1, hex2dec('7FFFFFFF'), ADMA_EXTERNAL_STARTCAPTURE + ADMA_TRIGGERED_STREAMING + ADMA_FIFO_ONLY_STREAMING);
if retCode ~= ApiSuccess
