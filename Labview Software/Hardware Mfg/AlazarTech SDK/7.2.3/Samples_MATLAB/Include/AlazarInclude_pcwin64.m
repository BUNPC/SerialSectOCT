...
%This function was generated by loadlibrary.m parser version  on Thu Dec 20 10:57:22 2018
...
fcns.thunkname{fcnNum}='uint32voidPtrvoidPtrvoidPtrThunk';fcns.name{fcnNum}='AlazarGetSDKVersion'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int32Ptr', 'int32Ptr', 'int32Ptr'};fcnNum=fcnNum+1;
% unsigned int AlazarGetDriverVersion ( U8 * major , U8 * minor , U8 * revision ); 
fcns.thunkname{fcnNum}='uint32voidPtrvoidPtrvoidPtrThunk';fcns.name{fcnNum}='AlazarGetDriverVersion'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int32Ptr', 'int32Ptr', 'int32Ptr'};fcnNum=fcnNum+1;
% unsigned int AlazarGetBoardRevision ( HANDLE handle , U8 * major , U8 * minor ); 
fcns.thunkname{fcnNum}='uint32voidPtrvoidPtrvoidPtrThunk';fcns.name{fcnNum}='AlazarGetBoardRevision'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'int32Ptr', 'int32Ptr'};fcnNum=fcnNum+1;
% U32 AlazarBoardsFound ( void ); 
fcns.thunkname{fcnNum}='ulongvoidThunk';fcns.name{fcnNum}='AlazarBoardsFound'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}=[];fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='uint32voidPtrvoidPtrvoidPtrThunk';fcns.name{fcnNum}='AlazarGetCPLDVersion'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'int32Ptr', 'int32Ptr'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='uint32voidPtrvoidPtrvoidPtrThunk';fcns.name{fcnNum}='AlazarGetChannelInfo'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'ulongPtr', 'int32Ptr'};fcnNum=fcnNum+1;
% unsigned int AlazarGetChannelInfoEx ( HANDLE handle , S64 * memorySize , U8 * bitsPerSample ); 
fcns.thunkname{fcnNum}='uint32voidPtrvoidPtrvoidPtrThunk';fcns.name{fcnNum}='AlazarGetChannelInfoEx'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'int64Ptr', 'int32Ptr'};fcnNum=fcnNum+1;
% unsigned int AlazarInputControl ( HANDLE handle , U8 channel , U32 coupling , U32 inputRange , U32 impedance ); 
fcns.thunkname{fcnNum}='uint32voidPtrint32ulongulongulongThunk';fcns.name{fcnNum}='AlazarInputControl'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'int32', 'ulong', 'ulong', 'ulong'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='uint32voidPtrint32int32ulongThunk';fcns.name{fcnNum}='AlazarSetPosition'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'int32', 'int32', 'ulong'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='uint32voidPtrvoidPtrulongvoidPtrulongulongulongulongulonglongvoidPtrThunk';fcns.name{fcnNum}='AlazarHyperDisp'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'voidPtr', 'ulong', 'int32Ptr', 'ulong', 'ulong', 'ulong', 'ulong', 'ulong', 'long', 'ulongPtr'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='uint32voidPtrint32ulonglongThunk';fcns.name{fcnNum}='AlazarSetParameter'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'int32', 'ulong', 'long'};fcnNum=fcnNum+1;
% unsigned int AlazarSetParameterUL ( HANDLE handle , U8 channel , U32 parameter , U32 value ); 
fcns.thunkname{fcnNum}='uint32voidPtrint32ulongulongThunk';fcns.name{fcnNum}='AlazarSetParameterUL'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'int32', 'ulong', 'ulong'};fcnNum=fcnNum+1;
% unsigned int AlazarSetParameterLL ( HANDLE handle , U8 channel , U32 parameter , S64 value ); 
fcns.thunkname{fcnNum}='uint32voidPtrint32ulongint64Thunk';fcns.name{fcnNum}='AlazarSetParameterLL'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'int32', 'ulong', 'int64'};fcnNum=fcnNum+1;
% unsigned int AlazarGetParameter ( HANDLE handle , U8 channel , U32 parameter , long * retValue ); 
fcns.thunkname{fcnNum}='uint32voidPtrint32ulongvoidPtrThunk';fcns.name{fcnNum}='AlazarGetParameter'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'int32', 'ulong', 'longPtr'};fcnNum=fcnNum+1;
% unsigned int AlazarGetParameterUL ( HANDLE handle , U8 channel , U32 parameter , U32 * retValue ); 
fcns.thunkname{fcnNum}='uint32voidPtrint32ulongvoidPtrThunk';fcns.name{fcnNum}='AlazarGetParameterUL'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'int32', 'ulong', 'ulongPtr'};fcnNum=fcnNum+1;
% unsigned int AlazarGetParameterLL ( HANDLE handle , U8 channel , U32 parameter , S64 * retValue ); 
fcns.thunkname{fcnNum}='uint32voidPtrint32ulongvoidPtrThunk';fcns.name{fcnNum}='AlazarGetParameterLL'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'int32', 'ulong', 'int64Ptr'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='ulongvoidThunk';fcns.name{fcnNum}='AlazarNumOfSystems'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}=[];fcnNum=fcnNum+1;
...
% unsigned int AlazarQueryCapabilityLL ( HANDLE handle , U32 capability , U32 reserved , S64 * retValue ); 
fcns.thunkname{fcnNum}='uint32voidPtrulongulongvoidPtrThunk';fcns.name{fcnNum}='AlazarQueryCapabilityLL'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'ulong', 'ulong', 'int64Ptr'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='uint32voidPtrvoidPtrulongulongThunk';fcns.name{fcnNum}='ReadC'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'int32Ptr', 'ulong', 'ulong'};fcnNum=fcnNum+1;
% void WriteC ( HANDLE handle , U8 * DmaBuffer , U32 SizeToRead , U32 LocalAddress ); 
fcns.thunkname{fcnNum}='voidvoidPtrvoidPtrulongulongThunk';fcns.name{fcnNum}='WriteC'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}=[]; fcns.RHS{fcnNum}={'voidPtr', 'int32Ptr', 'ulong', 'ulong'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='voidPtrvoidPtrulongThunk';fcns.name{fcnNum}='AlazarAllocBufferU8'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='int32Ptr'; fcns.RHS{fcnNum}={'voidPtr', 'ulong'};fcnNum=fcnNum+1;
% unsigned int AlazarFreeBufferU8 ( HANDLE handle , U8 * buffer ); 
fcns.thunkname{fcnNum}='uint32voidPtrvoidPtrThunk';fcns.name{fcnNum}='AlazarFreeBufferU8'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'int32Ptr'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='voidPtrvoidPtruint64Thunk';fcns.name{fcnNum}='AlazarAllocBufferU8Ex'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='int32Ptr'; fcns.RHS{fcnNum}={'voidPtr', 'uint64'};fcnNum=fcnNum+1;
% unsigned int AlazarFreeBufferU8Ex ( HANDLE handle , U8 * buffer ); 
fcns.thunkname{fcnNum}='uint32voidPtrvoidPtrThunk';fcns.name{fcnNum}='AlazarFreeBufferU8Ex'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'int32Ptr'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='uint32voidPtrint32Thunk';fcns.name{fcnNum}='AlazarSetADCBackgroundCompensation'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'int32'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='uint32voidPtrint32Thunk';fcns.name{fcnNum}='AlazarFFTBackgroundSubtractionSetEnabled'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'dsp_module_descriptorPtr', 'int32'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='uint32voidPtrint32voidPtrvoidPtrulongThunk';fcns.name{fcnNum}='AlazarFFTVerificationMode'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'dsp_module_descriptorPtr', 'int32', 'int16Ptr', 'int16Ptr', 'ulong'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='uint32voidPtrint32floatThunk';fcns.name{fcnNum}='AlazarFFTSetScalingAndSlicing'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'dsp_module_descriptorPtr', 'int32', 'single'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='uint32voidPtrint32ulongThunk';fcns.name{fcnNum}='AlazarDSPConfigureSelfTrigger'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'dsp_module_descriptorPtr', 'int32', 'ulong'};fcnNum=fcnNum+1;
% unsigned int AlazarDSPConfigureSampleSkipping ( dsp_module_handle dspHandle , U8 independentMode , U32 count , U16 * vector ); 
fcns.thunkname{fcnNum}='uint32voidPtrint32ulongvoidPtrThunk';fcns.name{fcnNum}='AlazarDSPConfigureSampleSkipping'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'dsp_module_descriptorPtr', 'int32', 'ulong', 'uint16Ptr'};fcnNum=fcnNum+1;
...
structs.s_NPTFooter.members=struct('triggerTimestamp', 'uint64', 'recordNumber', 'ulong', 'frameCount', 'ulong', 'aux_in_state', 'int32');
