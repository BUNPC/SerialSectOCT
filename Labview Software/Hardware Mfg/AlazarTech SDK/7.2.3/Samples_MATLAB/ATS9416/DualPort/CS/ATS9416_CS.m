...
channelMask = CHANNEL_A + CHANNEL_B + CHANNEL_C + CHANNEL_D + CHANNEL_E + CHANNEL_F + CHANNEL_G + CHANNEL_H + CHANNEL_I + CHANNEL_J + CHANNEL_K + CHANNEL_L + CHANNEL_M + CHANNEL_N + CHANNEL_O + CHANNEL_P;
...
retCode = AlazarBeforeAsyncRead(boardHandle, channelMask, 0, samplesPerBufferPerChannel, 1, hex2dec('7FFFFFFF'), ADMA_EXTERNAL_STARTCAPTURE + ADMA_CONTINUOUS_MODE + ADMA_FIFO_ONLY_STREAMING);
if retCode ~= ApiSuccess
