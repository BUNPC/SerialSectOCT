...
/** @defgroup TCubeNanoTrak TCube NanoTrak
 *  This section details the Structures and Functions relavent to the  @ref TNA001_page "TCube NanoTrak"<br />
 *  For an example of how to connect to the device and perform simple operations use the following links:
 *  <list type=bullet>
 *    <item> \ref namespaces_tna_ex_1 "Example of using the Thorlabs.MotionControl.TCube.NanoTrak.DLL from a C or C++ project."<br />
 *									  This requires the DLL to be dynamical linked. </item>
 *    <item> \ref namespaces_tna_ex_2 "Example of using the Thorlabs.MotionControl.TCube.NanoTrak.DLL from a C# project"<br />
 *									  This uses Marshalling to load and access the C DLL. </item>
 *  </list>
 *  The Thorlabs.MotionControl.TCube.NanoTrak.DLL requires the following DLLs
 *  <list type=bullet>
