...
// TCUBEDCSERVO_API functions as being imported from a DLL, whereas this DLL sees symbols
// defined with this macro as being exported.

#pragma once

#ifdef TCUBEDCSERVODLL_EXPORTS
#define TCUBEDCSERVO_API __declspec(dllexport)
#else
#define TCUBEDCSERVO_API __declspec(dllimport)
#endif
...
/** @defgroup TCubeDCServo TCube DCServo
 *  This section details the Structures and Functions relavent to the  @ref TDC001_page "TCube DC Servo"<br />
 *  For an example of how to connect to the device and perform simple operations use the following links:
 *  <list type=bullet>
 *    <item> \ref namespaces_tdc_ex_1 "Example of using the Thorlabs.MotionControl.TCube.DCServo.DLL from a C or C++ project."<br />
 *									  This requires the DLL to be dynamical linked. </item>
 *    <item> \ref namespaces_tdc_ex_2 "Example of using the Thorlabs.MotionControl.TCube.DCServo.DLL from a C# project"<br />
 *									  This uses Marshalling to load and access the C DLL. </item>
 *  </list>
 *  The Thorlabs.MotionControl.TCube.DCServo.DLL requires the following DLLs
 *  <list type=bullet>
 ...
 */
	...
	TCUBEDCSERVO_API short __cdecl TLI_BuildDeviceList(void);
	...
	/// <seealso cref="TLI_GetDeviceListByTypeExt(char *receiveBuffer, DWORD sizeOfBuffer, int typeID)" />
	/// <seealso cref="TLI_GetDeviceListByTypesExt(char *receiveBuffer, DWORD sizeOfBuffer, int * typeIDs, int length)" />
	TCUBEDCSERVO_API short __cdecl TLI_GetDeviceListSize();
	...
	/// <seealso cref="TLI_GetDeviceListByTypeExt(char *receiveBuffer, DWORD sizeOfBuffer, int typeID)" />
	/// <seealso cref="TLI_GetDeviceListByTypesExt(char *receiveBuffer, DWORD sizeOfBuffer, int * typeIDs, int length)" />
	TCUBEDCSERVO_API short __cdecl TLI_GetDeviceList(SAFEARRAY** stringsReceiver);
	...
	/// <seealso cref="TLI_GetDeviceListByTypeExt(char *receiveBuffer, DWORD sizeOfBuffer, int typeID)" />
	/// <seealso cref="TLI_GetDeviceListByTypesExt(char *receiveBuffer, DWORD sizeOfBuffer, int * typeIDs, int length)" />
	TCUBEDCSERVO_API short __cdecl TLI_GetDeviceListByType(SAFEARRAY** stringsReceiver, int typeID);
	...
	/// <seealso cref="TLI_GetDeviceListByTypeExt(char *receiveBuffer, DWORD sizeOfBuffer, int typeID)" />
	/// <seealso cref="TLI_GetDeviceListByTypesExt(char *receiveBuffer, DWORD sizeOfBuffer, int * typeIDs, int length)" />
	TCUBEDCSERVO_API short __cdecl TLI_GetDeviceListByTypes(SAFEARRAY** stringsReceiver, int * typeIDs, int length);
	...
	/// <seealso cref="TLI_GetDeviceListByTypeExt(char *receiveBuffer, DWORD sizeOfBuffer, int typeID)" />
	/// <seealso cref="TLI_GetDeviceListByTypesExt(char *receiveBuffer, DWORD sizeOfBuffer, int * typeIDs, int length)" />
	TCUBEDCSERVO_API short __cdecl TLI_GetDeviceListExt(char *receiveBuffer, DWORD sizeOfBuffer);
	...
	/// <seealso cref="TLI_GetDeviceListExt(char *receiveBuffer, DWORD sizeOfBuffer)" />
	/// <seealso cref="TLI_GetDeviceListByTypesExt(char *receiveBuffer, DWORD sizeOfBuffer, int * typeIDs, int length)" />
	TCUBEDCSERVO_API short __cdecl TLI_GetDeviceListByTypeExt(char *receiveBuffer, DWORD sizeOfBuffer, int typeID);
	...
	/// <seealso cref="TLI_GetDeviceListExt(char *receiveBuffer, DWORD sizeOfBuffer)" />
	/// <seealso cref="TLI_GetDeviceListByTypeExt(char *receiveBuffer, DWORD sizeOfBuffer, int typeID)" />
	TCUBEDCSERVO_API short __cdecl TLI_GetDeviceListByTypesExt(char *receiveBuffer, DWORD sizeOfBuffer, int * typeIDs, int length);
	...
	TCUBEDCSERVO_API short __cdecl CC_Open(char const * serialNo);
	...
	TCUBEDCSERVO_API void __cdecl CC_Close(char const * serialNo);
	...
	TCUBEDCSERVO_API bool __cdecl CC_CheckConnection(char const * serialNo);

	/// <summary> Sends a command to the device to make it identify iteself. </summary>
	/// <param name="serialNo">	The device serial no. </param>
	TCUBEDCSERVO_API void __cdecl CC_Identify(char const * serialNo);
	...
	TCUBEDCSERVO_API short __cdecl CC_RequestLEDswitches(char const * serialNo);
	...
	/// <seealso cref="CC_SetLEDswitches(char const * serialNo, WORD LEDswitches)" />
	TCUBEDCSERVO_API WORD __cdecl CC_GetLEDswitches(char const * serialNo);
	...
	/// <seealso cref="CC_RequestLEDswitches(char const * serialNo)" />
	/// <seealso cref="CC_GetLEDswitches(char const * serialNo)" />
	TCUBEDCSERVO_API short __cdecl CC_SetLEDswitches(char const * serialNo, WORD LEDswitches);
	...
	TCUBEDCSERVO_API short __cdecl CC_GetHardwareInfo(char const * serialNo, char * modelNo, DWORD sizeOfModelNo, WORD * type, WORD * numChannels, 
	...
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
    /// 		  \include CodeSnippet_identify.cpp
	TCUBEDCSERVO_API short __cdecl CC_GetHardwareInfoBlock(char const * serialNo, TLI_HardwareInformation *hardwareInfo);
	...
	TCUBEDCSERVO_API char __cdecl CC_GetHubBay(char const * serialNo);
    ...
    /// 		  \include CodeSnippet_identify.cpp
	TCUBEDCSERVO_API DWORD __cdecl CC_GetSoftwareVersion(char const * serialNo);
	...
	/// <param name="serialNo">	The device serial no. </param>
	/// <returns> <c>true</c> if successful, false if not. </returns>
	TCUBEDCSERVO_API bool __cdecl CC_PersistSettings(char const * serialNo);
	...
	TCUBEDCSERVO_API short __cdecl CC_DisableChannel(char const * serialNo);
	...
	TCUBEDCSERVO_API short __cdecl CC_EnableChannel(char const * serialNo);
	...
	TCUBEDCSERVO_API int __cdecl CC_GetNumberPositions(char const * serialNo);
    ...
    /// 		  \include CodeSnippet_move.cpp
	TCUBEDCSERVO_API short __cdecl CC_MoveToPosition(char const * serialNo, int index);
	...
	/// <seealso cref="CC_Home(char const * serialNo)" />
    /// 		  \include CodeSnippet_move.cpp
	TCUBEDCSERVO_API int __cdecl CC_GetPosition(char const * serialNo);
	...
	TCUBEDCSERVO_API bool __cdecl CC_CanMoveWithoutHomingFirst(char const * serialNo);
	...
	/// <seealso cref="CC_GetPosition(char const * serialNo)" />
    /// 		  \include CodeSnippet_move.cpp
	TCUBEDCSERVO_API short __cdecl CC_Home(char const * serialNo);
	...
	/// <param name="serialNo"> The device serial no. </param>
	TCUBEDCSERVO_API void __cdecl CC_ClearMessageQueue(char const * serialNo);
	...
	TCUBEDCSERVO_API void __cdecl CC_RegisterMessageCallback(char const * serialNo, void (* functionPointer)());
	...
	/// <seealso cref="CC_GetNextMessage(char const * serialNo, WORD * messageType, WORD * messageID, DWORD *messageData)" />
	/// <seealso cref="CC_WaitForMessage(char const * serialNo, WORD * messageType, WORD * messageID, DWORD *messageData)" />
	TCUBEDCSERVO_API int __cdecl CC_MessageQueueSize(char const * serialNo);
	...
	/// <seealso cref="CC_MessageQueueSize(char const * serialNo)" />
	/// <seealso cref="CC_WaitForMessage(char const * serialNo, WORD * messageType, WORD * messageID, DWORD *messageData)" />
	TCUBEDCSERVO_API bool __cdecl CC_GetNextMessage(char const * serialNo, WORD * messageType, WORD * messageID, DWORD *messageData);
	...
	/// <seealso cref="CC_MessageQueueSize(char const * serialNo)" />
	/// <seealso cref="CC_GetNextMessage(char const * serialNo, WORD * messageType, WORD * messageID, DWORD *messageData)" />
	TCUBEDCSERVO_API bool __cdecl CC_WaitForMessage(char const * serialNo, WORD * messageType, WORD * messageID, DWORD *messageData);
	...
	TCUBEDCSERVO_API short __cdecl CC_RequestHomingParams(char const * serialNo);
	...
	TCUBEDCSERVO_API unsigned int __cdecl CC_GetHomingVelocity(char const * serialNo);
	...
	/// <seealso cref="CC_GetHomingParamsBlock(char const * serialNo, MOT_HomingParameters *homingParams)" />
	/// <seealso cref="CC_SetHomingParamsBlock(char const * serialNo, MOT_HomingParameters *homingParams)" />
	TCUBEDCSERVO_API short __cdecl CC_SetHomingVelocity(char const * serialNo, unsigned int velocity);
	...
	/// <seealso cref="CC_MoveAtVelocity(char const * serialNo, MOT_TravelDirection direction)" />
    /// 		  \include CodeSnippet_move.cpp
	TCUBEDCSERVO_API short __cdecl CC_MoveRelative(char const * serialNo, int displacement);
	...
	TCUBEDCSERVO_API short __cdecl CC_RequestJogParams(const char * serialNo);
    ...
    /// 		  \include CodeSnippet_jogpars.cpp
	TCUBEDCSERVO_API short __cdecl CC_GetJogMode(char const * serialNo, MOT_JogModes * mode, MOT_StopModes * stopMode);
	...
	/// <seealso cref="CC_MoveJog(char const * serialNo, MOT_TravelDirection jogDirection)" />
    /// 		  \include CodeSnippet_jogpars.cpp
	TCUBEDCSERVO_API short __cdecl CC_SetJogMode(char const * serialNo, MOT_JogModes mode, MOT_StopModes stopMode);
	...
	/// <seealso cref="CC_MoveJog(char const * serialNo, MOT_TravelDirection jogDirection)" />
    /// 		  \include CodeSnippet_jogpars.cpp
	TCUBEDCSERVO_API unsigned int __cdecl CC_GetJogStepSize(char const * serialNo);
	...
	/// <seealso cref="CC_MoveJog(char const * serialNo, MOT_TravelDirection jogDirection)" />
    /// 		  \include CodeSnippet_jogpars.cpp
	TCUBEDCSERVO_API short __cdecl CC_SetJogStepSize(char const * serialNo, unsigned int stepSize);
	...
	/// <seealso cref="CC_MoveJog(char const * serialNo, MOT_TravelDirection jogDirection)" />
    /// 		  \include CodeSnippet_jogpars.cpp
	TCUBEDCSERVO_API short __cdecl CC_GetJogVelParams(char const * serialNo, int * acceleration, int * maxVelocity);
	...
	/// <seealso cref="CC_MoveJog(char const * serialNo, MOT_TravelDirection jogDirection)" />
    /// 		  \include CodeSnippet_jogpars.cpp
	TCUBEDCSERVO_API short __cdecl CC_SetJogVelParams(char const * serialNo, int acceleration, int maxVelocity);
	...
	TCUBEDCSERVO_API short __cdecl CC_MoveJog(char const * serialNo, MOT_TravelDirection jogDirection);

	/// <summary> Requests the move velocity parameters. </summary>
	/// <param name="serialNo"> The serial no. </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="CC_GetVelParams(char const * serialNo, int * acceleration, int * maxVelocity)" />
	/// <seealso cref="CC_GetVelParamsBlock(char const * serialNo, MOT_VelocityParameters * velocityParams)" />
	...
	TCUBEDCSERVO_API short __cdecl CC_GetVelParams(char const * serialNo, int * acceleration, int * maxVelocity);
	...
	/// <seealso cref="CC_MoveAtVelocity(char const * serialNo, MOT_TravelDirection direction)" />
    /// 		  \include CodeSnippet_movepars.cpp
	TCUBEDCSERVO_API short __cdecl CC_SetVelParams(char const * serialNo, int acceleration, int maxVelocity);
	...
	/// <seealso cref="CC_MoveRelative(char const * serialNo, int displacement)" />
    /// 		  \include CodeSnippet_move.cpp
	TCUBEDCSERVO_API short __cdecl CC_MoveAtVelocity(char const * serialNo, MOT_TravelDirection direction);
	...
	TCUBEDCSERVO_API void __cdecl CC_SetDirection(char const * serialNo, bool reverse);
	...
	TCUBEDCSERVO_API short __cdecl CC_StopImmediate(char const * serialNo);
	...
	TCUBEDCSERVO_API short __cdecl CC_StopProfiled(char const * serialNo);
	...
	TCUBEDCSERVO_API short __cdecl CC_RequestBacklash(char const * serialNo);
	...
	/// <seealso cref="CC_SetBacklash(char const * serialNo, long distance)" />
	TCUBEDCSERVO_API long __cdecl CC_GetBacklash(char const * serialNo);
	...
	/// <seealso cref="CC_RequestBacklash(char const * serialNo)" />
	/// <seealso cref="CC_GetBacklash(char const * serialNo)" />
	TCUBEDCSERVO_API short __cdecl CC_SetBacklash(char const * serialNo, long distance);
	...
	TCUBEDCSERVO_API long __cdecl CC_GetPositionCounter(char const * serialNo);
	...
	/// <seealso cref="CC_GetPosition(char const * serialNo)" />
	TCUBEDCSERVO_API short __cdecl CC_SetPositionCounter(char const * serialNo, long count);
	...
	TCUBEDCSERVO_API short __cdecl CC_RequestEncoderCounter(char const * serialNo);
	...
	/// <seealso cref="CC_SetEncoderCounter(char const * serialNo, long count)" />
	TCUBEDCSERVO_API long __cdecl CC_GetEncoderCounter(char const * serialNo);
	...
	/// <seealso cref="CC_RequestEncoderCounter(char const * serialNo)" />
	/// <seealso cref="CC_GetEncoderCounter(char const * serialNo)" />
	TCUBEDCSERVO_API short __cdecl CC_SetEncoderCounter(char const * serialNo, long count);
	...
	TCUBEDCSERVO_API short __cdecl CC_RequestLimitSwitchParams(char const * serialNo);
	...
	/// <seealso cref="CC_GetLimitSwitchParamsBlock(const char * serialNo, MOT_LimitSwitchParameters *limitSwitchParams)" />
	TCUBEDCSERVO_API short __cdecl CC_GetLimitSwitchParams(char const * serialNo, MOT_LimitSwitchModes * clockwiseHardwareLimit, MOT_LimitSwitchModes * anticlockwiseHardwareLimit, unsigned int * clockwisePosition, unsigned int * anticlockwisePosition, MOT_LimitSwitchSWModes * softLimitMode);
	...
	/// <seealso cref="CC_SetLimitSwitchParamsBlock(const char * serialNo, MOT_LimitSwitchParameters *limitSwitchParams)" />
	/// <seealso cref="CC_GetLimitSwitchParamsBlock(const char * serialNo, MOT_LimitSwitchParameters *limitSwitchParams)" />
	TCUBEDCSERVO_API short __cdecl CC_SetLimitSwitchParams(char const * serialNo, MOT_LimitSwitchModes clockwiseHardwareLimit, MOT_LimitSwitchModes anticlockwiseHardwareLimit, unsigned int clockwisePosition, unsigned int anticlockwisePosition, MOT_LimitSwitchSWModes softLimitMode);
	...
	TCUBEDCSERVO_API MOT_LimitsSoftwareApproachPolicy __cdecl CC_GetSoftLimitMode(char const * serialNo);
	...
	TCUBEDCSERVO_API short __cdecl CC_RequestButtonParams(char const * serialNo);
	...
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="CC_RequestButtonParams(char const * serialNo)" />
	/// <seealso cref="CC_SetButtonParams(char const * serialNo, MOT_ButtonModes buttonMode, int leftButtonPosition, int rightButtonPosition)" />
	/// <seealso cref="CC_SetButtonParamsBlock(const char * serialNo, MOT_ButtonParameters *buttonParams)" />
	/// <seealso cref="CC_GetButtonParamsBlock(const char * serialNo, MOT_ButtonParameters *buttonParams)" />
	TCUBEDCSERVO_API short __cdecl CC_GetButtonParams(char const * serialNo, MOT_ButtonModes * buttonMode, int * leftButtonPosition, int * rightButtonPosition, short * timeout);
	...
	/// <seealso cref="CC_SetButtonParamsBlock(const char * serialNo, MOT_ButtonParameters *buttonParams)" />
	/// <seealso cref="CC_GetButtonParamsBlock(const char * serialNo, MOT_ButtonParameters *buttonParams)" />
	TCUBEDCSERVO_API short __cdecl CC_SetButtonParams(char const * serialNo, MOT_ButtonModes buttonMode, int leftButtonPosition, int rightButtonPosition);
	...
	TCUBEDCSERVO_API short __cdecl CC_RequestPotentiometerParams(char const * serialNo);
	...
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="CC_RequestPotentiometerParams(char const * serialNo)" />
	/// <seealso cref="CC_SetPotentiometerParams(char const * serialNo, short index, WORD thresholdDeflection, DWORD velocity)" />
	TCUBEDCSERVO_API short __cdecl CC_GetPotentiometerParams(char const * serialNo, short index, WORD * thresholdDeflection, DWORD * velocity);
	...
	/// <seealso cref="CC_RequestPotentiometerParams(char const * serialNo)" />
	/// <seealso cref="CC_GetPotentiometerParams(char const * serialNo, short index, WORD * thresholdDeflection, DWORD * velocity)" />
	TCUBEDCSERVO_API short __cdecl CC_SetPotentiometerParams(char const * serialNo, short index, WORD thresholdDeflection, DWORD velocity);
	...
	/// <seealso cref="CC_MoveAtVelocity(char const * serialNo, MOT_TravelDirection direction)" />
    /// 		  \include CodeSnippet_movepars.cpp
	TCUBEDCSERVO_API short __cdecl CC_GetVelParamsBlock(const char * serialNo, MOT_VelocityParameters  *velocityParams);
	...
	/// <seealso cref="CC_MoveAtVelocity(char const * serialNo, MOT_TravelDirection direction)" />
    /// 		  \include CodeSnippet_movepars.cpp
	TCUBEDCSERVO_API short __cdecl CC_SetVelParamsBlock(const char * serialNo, MOT_VelocityParameters *velocityParams);
	...
	TCUBEDCSERVO_API short __cdecl CC_SetMoveAbsolutePosition(const char * serialNo, int position);
	...
	/// <seealso cref="CC_MoveAbsolute(const char * serialNo)" />
	TCUBEDCSERVO_API short __cdecl CC_RequestMoveAbsolutePosition(char const * serialNo);
	...
	/// <seealso cref="CC_SetMoveAbsolutePosition(const char * serialNo, int position)" />
	/// <seealso cref="CC_MoveAbsolute(const char * serialNo)" />
	TCUBEDCSERVO_API int __cdecl CC_GetMoveAbsolutePosition(const char * serialNo);
	...
	/// <seealso cref="CC_SetMoveAbsolutePosition(const char * serialNo, int position)" />
	/// <seealso cref="CC_GetMoveAbsolutePosition(const char * serialNo)" />
	TCUBEDCSERVO_API short __cdecl CC_MoveAbsolute(const char * serialNo);
	...
	TCUBEDCSERVO_API short __cdecl CC_SetMoveRelativeDistance(const char * serialNo, int distance);

	/// <summary> Requests the move relative distance. </summary>
	/// <param name="serialNo"> The serial no. </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="CC_SetMoveRelativeDistance(const char * serialNo, int distance)" />
	/// <seealso cref="CC_GetMoveRelativeDistance(const char * serialNo)" />
	/// <seealso cref="CC_MoveRelativeDistance(const char * serialNo)" />
	TCUBEDCSERVO_API short __cdecl CC_RequestMoveRelativeDistance(char const * serialNo);
	...
	/// <seealso cref="CC_SetMoveRelativeDistance(const char * serialNo, int distance)" />
	/// <seealso cref="CC_MoveRelativeDistance(const char * serialNo)" />
	TCUBEDCSERVO_API int __cdecl CC_GetMoveRelativeDistance(const char * serialNo);
	...
	/// <seealso cref="CC_SetMoveRelativeDistance(const char * serialNo, int distance)" />
	/// <seealso cref="CC_GetMoveRelativeDistance(const char * serialNo)" />
	TCUBEDCSERVO_API short __cdecl CC_MoveRelativeDistance(const char * serialNo);
	...
	/// <seealso cref="CC_SetHomingVelocity(char const * serialNo, unsigned int velocity)" />
	/// <seealso cref="CC_SetHomingParamsBlock(char const * serialNo, MOT_HomingParameters *homingParams)" />
	TCUBEDCSERVO_API short __cdecl CC_GetHomingParamsBlock(const char * serialNo, MOT_HomingParameters *homingParams);
	...
	/// <seealso cref="CC_SetHomingVelocity(char const * serialNo, unsigned int velocity)" />
	/// <seealso cref="CC_GetHomingParamsBlock(char const * serialNo, MOT_HomingParameters *homingParams)" />
	TCUBEDCSERVO_API short __cdecl CC_SetHomingParamsBlock(const char * serialNo, MOT_HomingParameters *homingParams);
	...
	/// <seealso cref="CC_MoveJog(char const * serialNo, MOT_TravelDirection jogDirection)" />
    /// 		  \include CodeSnippet_jogpars.cpp
	TCUBEDCSERVO_API short __cdecl CC_GetJogParamsBlock(const char * serialNo, MOT_JogParameters *jogParams);
	...
	/// <seealso cref="CC_MoveJog(char const * serialNo, MOT_TravelDirection jogDirection)" />
    /// 		  \include CodeSnippet_jogpars.cpp
	TCUBEDCSERVO_API short __cdecl CC_SetJogParamsBlock(const char * serialNo, MOT_JogParameters *jogParams);
	...
	/// <seealso cref="CC_SetButtonParams(char const * serialNo, MOT_ButtonModes buttonMode, int leftButtonPosition, int rightButtonPosition)" />
	/// <seealso cref="CC_GetButtonParams(char const * serialNo, MOT_ButtonModes * buttonMode, int * leftButtonPosition, int * rightButtonPosition, short * timeout)" />
	TCUBEDCSERVO_API short __cdecl CC_GetButtonParamsBlock(const char * serialNo, MOT_ButtonParameters *buttonParams);
	...
	/// <seealso cref="CC_GetButtonParams(char const * serialNo, MOT_ButtonModes * buttonMode, int * leftButtonPosition, int * rightButtonPosition, short * timeout)" />
	/// <seealso cref="CC_SetButtonParams(char const * serialNo, MOT_ButtonModes buttonMode, int leftButtonPosition, int rightButtonPosition)" />
	TCUBEDCSERVO_API short __cdecl CC_SetButtonParamsBlock(const char * serialNo, MOT_ButtonParameters *buttonParams);
	...
	/// <seealso cref="CC_SetPotentiometerParams(char const * serialNo, short index, WORD thresholdDeflection, DWORD velocity)" />
	/// <seealso cref="CC_GetPotentiometerParams(char const * serialNo, short index, WORD * thresholdDeflection, DWORD * velocity)" />
	TCUBEDCSERVO_API short __cdecl CC_GetPotentiometerParamsBlock(const char * serialNo, MOT_PotentiometerSteps *potentiometerSteps);
	...
	/// <seealso cref="CC_SetPotentiometerParams(char const * serialNo, short index, WORD thresholdDeflection, DWORD velocity)" />
	/// <seealso cref="CC_GetPotentiometerParams(char const * serialNo, short index, WORD * thresholdDeflection, DWORD * velocity)" />
	TCUBEDCSERVO_API short __cdecl CC_SetPotentiometerParamsBlock(const char * serialNo, MOT_PotentiometerSteps *potentiometerSteps);
	...
	/// <seealso cref="CC_GetLimitSwitchParams(char const * serialNo, MOT_LimitSwitchModes * clockwiseHardwareLimit, MOT_LimitSwitchModes * anticlockwiseHardwareLimit, unsigned int * clockwisePosition, unsigned int * anticlockwisePosition, MOT_LimitSwitchSWModes * softLimitMode)" />
	/// <seealso cref="CC_SetLimitSwitchParamsBlock(const char * serialNo, MOT_LimitSwitchParameters *limitSwitchParams)" />
	TCUBEDCSERVO_API short __cdecl CC_GetLimitSwitchParamsBlock(const char * serialNo, MOT_LimitSwitchParameters *limitSwitchParams);
	...
	/// <seealso cref="CC_SetLimitSwitchParams(char const * serialNo, MOT_LimitSwitchModes clockwiseHardwareLimit, MOT_LimitSwitchModes anticlockwiseHardwareLimit, unsigned int clockwisePosition, unsigned int anticlockwisePosition, MOT_LimitSwitchSWModes softLimitMode)" />
	/// <seealso cref="CC_GetLimitSwitchParamsBlock(const char * serialNo, MOT_LimitSwitchParameters *limitSwitchParams)" />
	TCUBEDCSERVO_API short __cdecl CC_SetLimitSwitchParamsBlock(const char * serialNo, MOT_LimitSwitchParameters *limitSwitchParams);
	...
	TCUBEDCSERVO_API short __cdecl CC_SuspendMoveMessages(char const * serialNo);

	/// <summary> Resume suspended move messages. </summary>
	/// <param name="serialNo">	The device serial no. </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="CC_SuspendMoveMessages(char const * serialNo)" />
	TCUBEDCSERVO_API short __cdecl CC_ResumeMoveMessages(char const * serialNo);
	...
	TCUBEDCSERVO_API short __cdecl CC_RequestPosition(char const * serialNo);
	...
	/// <seealso cref="CC_StartPolling(char const * serialNo, int milliseconds)" />
	TCUBEDCSERVO_API short __cdecl CC_RequestStatusBits(char const * serialNo);
	...
	/// <seealso cref="CC_StartPolling(char const * serialNo, int milliseconds)" />
	TCUBEDCSERVO_API DWORD __cdecl CC_GetStatusBits(char const * serialNo);
	...
	/// \include CodeSnippet_connection1.cpp
	TCUBEDCSERVO_API bool __cdecl CC_StartPolling(char const * serialNo, int milliseconds);
	...
	/// <seealso cref="CC_StopPolling(char const * serialNo)" />
	/// \include CodeSnippet_connection1.cpp
	TCUBEDCSERVO_API long __cdecl CC_PollingDuration(char const * serialNo);
	...
	/// <seealso cref="CC_PollingDuration(char const * serialNo)" />
	/// \include CodeSnippet_connection1.cpp
	TCUBEDCSERVO_API void __cdecl CC_StopPolling(char const * serialNo);
	...
	TCUBEDCSERVO_API bool __cdecl CC_TimeSinceLastMsgReceived(char const * serialNo, __int64 &lastUpdateTimeMS );
	...
	/// <seealso cref="CC_HasLastMsgTimerOverrun(char const * serialNo)" />
	/// \include CodeSnippet_connectionMonitoring.cpp
	TCUBEDCSERVO_API void __cdecl CC_EnableLastMsgTimer(char const * serialNo, bool enable, __int32 lastMsgTimeout );
	...
	/// <seealso cref="CC_EnableLastMsgTimer(char const * serialNo, bool enable, __int32 lastMsgTimeout )" />
	/// \include CodeSnippet_connectionMonitoring.cpp
	TCUBEDCSERVO_API bool __cdecl CC_HasLastMsgTimerOverrun(char const * serialNo);
	...
	/// <param name="serialNo">	The device serial no. </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successfully requested. </returns>
	TCUBEDCSERVO_API short __cdecl CC_RequestSettings(char const * serialNo);
	...
	TCUBEDCSERVO_API int __cdecl CC_GetStageAxisMinPos(char const * serialNo);
	...
	TCUBEDCSERVO_API int __cdecl CC_GetStageAxisMaxPos(char const * serialNo);
	...
	/// <seealso cref="CC_GetStageAxisMinPos(char const * serialNo)" />
	/// <seealso cref="CC_GetStageAxisMaxPos(char const * serialNo)" />
	TCUBEDCSERVO_API short __cdecl CC_SetStageAxisLimits(char const * serialNo, int minPosition, int maxPosition);
	...
	TCUBEDCSERVO_API short __cdecl CC_SetMotorTravelMode(char const * serialNo, MOT_TravelModes travelMode);
	...
	TCUBEDCSERVO_API short __cdecl CC_GetMotorParams(char const * serialNo, long *stepsPerRev, long *gearBoxRatio, float *pitch);
	...
	TCUBEDCSERVO_API short __cdecl CC_SetMotorParamsExt(char const * serialNo, double stepsPerRev, double gearBoxRatio, double pitch);
	...
	TCUBEDCSERVO_API short __cdecl CC_GetMotorParamsExt(char const * serialNo, double *stepsPerRev, double *gearBoxRatio, double *pitch);
	...
	TCUBEDCSERVO_API short __cdecl CC_SetMotorVelocityLimits(char const * serialNo, double maxVelocity, double maxAcceleration);
	...
	TCUBEDCSERVO_API short __cdecl CC_GetMotorVelocityLimits(char const * serialNo, double *maxVelocity, double *maxAcceleration);
	...
	TCUBEDCSERVO_API short __cdecl CC_ResetRotationModes(char const * serialNo);
	...
	TCUBEDCSERVO_API short __cdecl CC_SetRotationModes(char const * serialNo, MOT_MovementModes mode, MOT_MovementDirections direction);
	...
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="CC_GetMotorTravelLimits(char const * serialNo, double *minPosition, double *maxPosition)" />
	TCUBEDCSERVO_API short __cdecl CC_SetMotorTravelLimits(char const * serialNo, double minPosition, double maxPosition);
	...
	TCUBEDCSERVO_API short __cdecl CC_GetDeviceUnitFromRealValue(char const * serialNo, double real_unit, int *device_unit, int unitType);
